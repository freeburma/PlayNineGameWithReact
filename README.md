This is the Play Nine Game source code by following the tutorial from PluralSight. I was using NodeJS with VisualStudio code. The instructor used the jsComplete playground. If someone would like to build it on your local computer, just download source code and run it. 

Type the following in the Terminal or CMD
  $ npm start 


You will need the following NPM dependicies packages. Please read the require dependicies below. 
  $ npm install lodash
  ...
  Note: You might need to install dependicies. 
  $ npm install 
